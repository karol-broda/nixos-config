  ...
  programs.nixvim.plugins.telescope = {
    ...
    settings.defaults = {
      ...
      file_ignore_patterns = [
        ...
        "^output/" "^data/" "^node_modules/" "%.ipynb"
      ];
      mappings.i = {
    ...
    keymaps = {
      ...
      "<leader>fg" = {action = "live_grep"; options.desc = "grep in cwd";};
      "<leader>fb" = {action = "buffers"; options.desc = "buffers";};
      "<leader>fh" = {action = "help_tags"; options.desc = "help pages";};
      ...
      "<leader>sm" = {action = "marks"; options.desc = "marks";};
      "<leader>sr" = {action = "resume"; options.desc = "resume last search";};
    };
  };
}
