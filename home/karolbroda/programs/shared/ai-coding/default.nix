...
in
{
  ...
  home = {
    ...
    file.".claude/rules/coding-principles.md".source = ./rules/coding-principles.md;
    file.".claude/rules/nix.md".source = ./rules/nix.md;
    file.".claude/rules/typescript.md".source = ./rules/typescript.md;
    file.".claude/rules/python.md".source = ./rules/python.md;
    file.".claude/rules/go.md".source = ./rules/go.md;
    file.".claude/rules/rust.md".source = ./rules/rust.md;
    file.".claude/rules/c.md".source = ./rules/c.md;
    file.".claude/rules/zig.md".source = ./rules/zig.md;
  };
